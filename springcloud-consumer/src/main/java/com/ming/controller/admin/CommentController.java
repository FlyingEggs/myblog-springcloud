...
import com.ming.dto.cond.CommentCond;
...
//    private CommentService commentService;
    ...
    @GetMapping(value = "/myblog-provider/admin/comments/")
    public String index(
...
//        request.setAttribute("comments", comments);
    	feignProviderService.commentIndex(page, limit, request);
        return "admin/comment_list";
    }

    @ApiOperation("删除一条评论")
    @PostMapping(value = "/myblog-provider/admin/comments/delete")
    @ResponseBody
...
//        }
    	feignProviderService.deleteComment(coid);
        return APIResponse.success();
    }

    @ApiOperation("更改评论状态")
    @PostMapping(value = "/myblog-provider/admin/comments/status")
    @ResponseBody
...
//            return APIResponse.fail(e.getMessage());
//        }
    	feignProviderService.changeStatus(coid, status);
        return APIResponse.success();
    }
