...
//    private LogService logService;
    ...
    @ApiOperation("文章页")
    @GetMapping(value = "/myblog-provider/admin/article/")
    public String index(
...
//        request.setAttribute("articles", articles);
    ...
    @ApiOperation("发布文章页")
    @GetMapping(value = "/myblog-provider/admin/article/publish")
...
//        request.setAttribute("categories", metas);
    	feignProviderService.newArticle(request);
        return "admin/article_edit";
    }

    @ApiOperation("发布新文章")
    @PostMapping(value = "/myblog-provider/admin/article/publish")
    @ResponseBody
...
//        contentService.addArticle(contentDomain);
            feignProviderService.publishArticle(request, title, titlePic, slug, content, type, status, tags, categories, allowComment);
    ...
    @ApiOperation("文章编辑页")
    @GetMapping(value = "/myblog-provider/admin/article/{cid}")
...
//        request.setAttribute("active", "article");
    	feignProviderService.editArticle(cid, request);
        return "admin/article_edit";
    }

    @ApiOperation("编辑保存文章")
    @PostMapping("/myblog-provider/admin/article/modify")
    @ResponseBody
...
//        contentService.updateArticleById(contentDomain);
    	feignProviderService.modifyArticle(request, cid, title, titlePic, slug, content, type, status, tags, categories, allowComment);
        return APIResponse.success();
    }

    @ApiOperation("删除文章")
    @PostMapping(value = "/myblog-provider/admin/article/delete")
    @ResponseBody
...
//            logService.addLog(LogActions.DEL_ARTICLE.getAction(), cid + "", request.getRemoteAddr(), this.getUid(request));
    	feignProviderService.deleteArticle(cid, request);
            return APIResponse.success();
    }
}
