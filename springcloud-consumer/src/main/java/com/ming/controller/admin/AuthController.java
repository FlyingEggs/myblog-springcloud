...
//    private LogService logService;
    ...
    @ApiOperation("跳转登录页")
    @GetMapping(value = "/myblog-provider/admin/login")
    public String login(){
        return "admin/login";
    }

    @ApiOperation("登录")
    @PostMapping(value = "/myblog-provider/admin/login")
    @ResponseBody
...
//        }
//
    	feignProviderService.toLogin(request, response, username, password, remeber_me);
     ...
     * @param response
     */
    @RequestMapping("/myblog-provider/admin/logout")
...
//            LOGGER.error("注销失败", e);
//        }
    	feignProviderService.logout(session, response, request);
    }
