...
@Api("系统设置")
@Controller
//@RequestMapping("/myblog-provider/admin/setting")
...
//    private LogService logService;
    ...
    @ApiOperation("进入设置页")
    @GetMapping(value = "/myblog-provider/admin/setting/")
...
//        request.setAttribute("options", options);
    	feignProviderService.setting(request);
        return "admin/setting";
    }


    @ApiOperation("保存系统设置")
    @PostMapping(value = "/myblog-provider/admin/setting/")
    @ResponseBody
...
//        }
    	return feignProviderService.saveSetting(request);
    }
