...
@Api("友链")
@Controller
//@RequestMapping(value = "/myblog-provider/admin/links")
...
//    private MetaService metaService;
    ...
    @ApiOperation("友链页面")
    @GetMapping(value = "/myblog-provider/admin/links/")
...
//        request.setAttribute("links", metas);
    	feignProviderService.linksIndex(request);
        return "admin/links";
    }

    @ApiOperation("新增友链")
    @PostMapping(value = "/myblog-provider/admin/links/save")
    @ResponseBody
...
//        }
    	feignProviderService.addLink(title, url, logo, mid, sort);
        return APIResponse.success();
    }


    @ApiOperation("删除友链")
    @PostMapping(value = "/myblog-provider/admin/links/delete")
    @ResponseBody
